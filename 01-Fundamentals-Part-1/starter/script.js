...
console.log(ageJonas > ageSarah); // comparison operators
...
if (money) {
  ...
  console.log(`You shoyld get a job!`);
}
...
const dolScore2 = 112;
const dolScore3 = 81;
const dolphinsAvg = (dolScore1 + dolScore2 + dolScore3) / 3;
const koaScore1 = 109;
const koaScore2 = 95;
const koaScore3 = 86;
const koalasAvg = (koaScore1 + koaScore2 + koaScore3) / 3;
...
/*
const bill = 430;
const tip = bill >= 50 && bill <= 300 ? Number((bill * 0.15).toFixed(2)) : Number((bill * 0.2).toFixed(2));
